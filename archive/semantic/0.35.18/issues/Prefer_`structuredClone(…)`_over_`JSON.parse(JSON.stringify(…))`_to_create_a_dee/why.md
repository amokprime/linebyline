...
### Documentation
  ...
  * [eslint-plugin-unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn#readme) \- Rule [prefer-structured-clone](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/HEAD/docs/rules/prefer-structured-clone.md)
  * MDN: structuredClone() - [Official documentation for the structuredClone() API](https://developer.mozilla.org/en-US/docs/Web/API/structuredClone)
  * MDN: Structured Clone Algorithm - [Details about the structured clone algorithm and supported data types](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API/Structured_clone_algorithm)