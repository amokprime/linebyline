...
### Documentation
  ...
  * [eslint-plugin-unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn#readme) \- Rule [no-zero-fractions](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/HEAD/docs/rules/no-zero-fractions.md)
  * MDN - Number literals - [Official documentation about JavaScript numeric literals and their syntax](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Grammar_and_types#numeric_literals)
  * ESLint - no-floating-decimal - [Related ESLint rule that addresses floating decimal points](https://eslint.org/docs/latest/rules/no-floating-decimal)