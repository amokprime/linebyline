...
This part at the end needs to be cleaned up in next version:
```
somenumber
Embed
```
...
- [x] Typing "a", then Enter, then "b", then Enter, then "c" very quickly on newlines get undone and redone in one step
- [x] Typing "a", then Enter, then "b", then Enter, then "c" slowly on newlines get undone and redone in five steps
