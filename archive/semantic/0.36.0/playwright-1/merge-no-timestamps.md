...
- Name: fields-merge.spec.js >> merge-no-timestamps
- Location: tests\fields-merge.spec.js:76:1
  ...
  - generic [ref=e43]:
    - generic [ref=e44]:
      ...
      - region "Now playing" [ref=e51]:
        - generic "Song title" [ref=e52]: audio
    ...
    - generic [ref=e148]:
      ...
      - generic [ref=e164]:
        - banner "Secondary 1 field header" [ref=e165]:
          - generic [ref=e166]: Secondary 1
          - generic [ref=e167]:
            - button "Import secondary lyrics file" [ref=e168] [cursor=pointer]: 📂
            - generic "Wrap all secondary lines in parentheses" [ref=e169] [cursor=pointer]:
              - checkbox "( )" [checked] [ref=e170]
              - text: ( )
        - textbox "Secondary 1 lyrics" [ref=e171]
```
