...
### Documentation
  ...
  * [eslint-plugin-unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn#readme) \- Rule [prefer-dom-node-dataset](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/HEAD/docs/rules/prefer-dom-node-dataset.md)
  * MDN: HTMLElement.dataset - [Official documentation for the dataset API](https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement/dataset)
  * MDN: Using data attributes - [Guide on using HTML data attributes effectively](https://developer.mozilla.org/en-US/docs/Learn/HTML/Howto/Use_data_attributes)