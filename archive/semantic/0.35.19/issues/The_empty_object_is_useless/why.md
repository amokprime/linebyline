...
### Documentation
  ...
  * [eslint-plugin-unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn#readme) \- Rule [no-useless-fallback-in-spread](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/HEAD/docs/rules/no-useless-fallback-in-spread.md)
  * MDN - Spread syntax - [Official documentation about the spread operator in JavaScript](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Spread_syntax)
  * MDN - Falsy values - [Explanation of falsy values in JavaScript](https://developer.mozilla.org/en-US/docs/Glossary/Falsy)
  * MDN - Logical OR operator - [Documentation for the logical OR operator](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Logical_OR)
  * MDN - Nullish coalescing operator - [Documentation for the nullish coalescing operator](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Nullish_coalescing)