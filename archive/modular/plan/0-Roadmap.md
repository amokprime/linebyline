...
**In progress — tranche 4 done 2026-09-06** (ControlsPanel/HotkeyCell). Tranche plan, following the leaf-first migration order:
...
- **Later tranches**: SettingsDialog (shadcn-vue `Dialog`) → **global keyboard handler last**; Phase D state composables bind the inert controls as they land.
