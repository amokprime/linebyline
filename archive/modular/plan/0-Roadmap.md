...
**In progress — tranche 5 done 2026-09-06** (SettingsDialog on shadcn-vue Dialog). Tranche plan, following the leaf-first migration order:
...
- **Later tranches**: **global keyboard handler last**; Phase D state composables bind the inert controls as they land.
