...
**In progress — tranche 3 done 2026-09-06** (main layout frame). Tranche plan, following the leaf-first migration order:
...
- **Later tranches**: ControlsPanel/HotkeyCell (hotkey grid + mode cell) → SettingsDialog (shadcn-vue `Dialog`) → **global keyboard handler last**; Phase D state composables bind the inert controls as they land.
