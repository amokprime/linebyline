...
3. Present
    ...
    2. Skip in-chat prose output for a code file you built and instead present a companion .md file (i.e. linebyline-0.34.9.html → linebyline-0.34.9.md). This should:
	    1. Include each turn discussing or building that code file version only
	    2. Append per turn:
		    ...
		    4. Another "---" line
	3. Also edit and present a renamed version of CHECKLIST.md from project files
		1. Example: linebyline-0.34.9.html + CHECKLIST.md → checklist-0.34.9.md)
		2. Identify each box that could be broken by changes for this code version
			1. Check them with an x like `- [x] `
			2. Make no other edits in the file
4. Update
