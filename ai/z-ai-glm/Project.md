...
4. *Each turn*, without prompting, copy *only* files you created or updated that turn to downloads
    ...
    3. Create a companion .md file (i.e. linebyline-0.34.9.html → linebyline-0.34.9.md). If the version is to be kept the same and the file already exists, update it.
