...
#
# The user's `dpl` abbreviation runs ai/chat.z.ai/scripts/delivery/unpack.sh
# which extracts deliver.zip, runs deploy.sh, and cleans up. See
# project-workflow-SKILL.md → "Deliver zip pattern" for the full protocol.
# This script's committed repo copy lives at ai/chat.z.ai/scripts/delivery/prepare.sh.
#
