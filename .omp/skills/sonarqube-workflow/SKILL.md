...
globs: ["docs/index.html", ".github/workflows/*.yml"]
alwaysApply: false
---
...
Document Won't Fix decisions in the hand-curated project memory file (e.g. `ai/chat.z.ai/Memory.md` for the LineByLine historical record). Standard rationales:
